...
public class MaterialCreator extends BaseMekanismMaterial {
    ...
    public MaterialCreator(IMekanismConfig config, ForgeConfigSpec.Builder builder, BaseMekanismMaterial materialDefaults) {
        ...
        //Note: Currently we don't allow mekanism.tools that have float damage values to go negative, this predicate is used for ones
        ...
        toolMaxUses = CachedIntValue.wrap(config, builder.comment("Maximum durability of " + toolKey + " mekanism.tools.")
              .defineInRange(toolKey + "ToolMaxUses", materialDefaults.getMaxUses(), 1, Integer.MAX_VALUE));
        efficiency = CachedFloatValue.wrap(config, builder.comment("Efficiency of " + toolKey + " mekanism.tools.")
        ...
        harvestLevel = CachedIntValue.wrap(config, builder.comment("Harvest level of " + toolKey + " mekanism.tools.")
