...
public final class HolidayManager {
    ...
    public static class Christmas extends Holiday {
        ...
        public void onEvent(PlayerEntity player) {
            ...
            player.sendSystemMessage(MekanismLang.HOLIDAY_BORDER.translate(themedLines, MekanismLang.GENERIC_SQUARE_BRACKET.translateColored(EnumColor.DARK_BLUE, MekanismLang.MEKANISM)), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.CHRISTMAS_LINE_ONE.translateColored(EnumColor.RED, EnumColor.DARK_BLUE, player.getName()), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.CHRISTMAS_LINE_TWO.translateColored(EnumColor.RED), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.CHRISTMAS_LINE_THREE.translateColored(EnumColor.RED), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.CHRISTMAS_LINE_FOUR.translateColored(EnumColor.RED), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.HOLIDAY_SIGNATURE.translateColored(EnumColor.DARK_GRAY), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.HOLIDAY_BORDER.translate(themedLines, EnumColor.DARK_BLUE, "[=======]"), Util.NIL_UUID);
        }
    ...
    public static class NewYear extends Holiday {
        ...
        public void onEvent(PlayerEntity player) {
            ...
            player.sendSystemMessage(MekanismLang.HOLIDAY_BORDER.translate(themedLines, MekanismLang.GENERIC_SQUARE_BRACKET.translateColored(EnumColor.DARK_BLUE, MekanismLang.MEKANISM)), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.NEW_YEAR_LINE_ONE.translateColored(EnumColor.AQUA, EnumColor.DARK_BLUE, player.getName()), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.NEW_YEAR_LINE_TWO.translateColored(EnumColor.AQUA), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.NEW_YEAR_LINE_THREE.translateColored(EnumColor.AQUA, calendar.get(Calendar.YEAR)), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.HOLIDAY_SIGNATURE.translateColored(EnumColor.DARK_GRAY), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.HOLIDAY_BORDER.translate(themedLines, EnumColor.DARK_BLUE, "[=======]"), Util.NIL_UUID);
        }
    }
    ...
    public static class May4 extends Holiday {
        ...
        public void onEvent(PlayerEntity player) {
            ...
            player.sendSystemMessage(MekanismLang.HOLIDAY_BORDER.translate(themedLines, MekanismLang.GENERIC_SQUARE_BRACKET.translateColored(EnumColor.DARK_BLUE, MekanismLang.MEKANISM)), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.MAY_4_LINE_ONE.translateColored(EnumColor.GRAY, EnumColor.DARK_BLUE, player.getName()), Util.NIL_UUID);
            player.sendSystemMessage(MekanismLang.HOLIDAY_BORDER.translate(themedLines, EnumColor.DARK_BLUE, "[=======]"), Util.NIL_UUID);
        }
    }
