...
When compiling against the AE2 API you can use gradle dependencies, just add
    ...
    dependencies {
        modCompileOnly "mekanism:appliedenergistics2-fabric:VERSION:api"
        
        // Include only if you want AE2 at runtime
        modRuntimeOnly "mekanism:appliedenergistics2-fabric:VERSION"    
    }
...
An example string would be `mekanism:appliedenergistics2:7.0.0-alpha.6:api` for the API only or `mekanism:appliedenergistics2:7.0.0-alpha.6` for the whole mod.
...
However the dependency might need to be wrapped in `fg.deobf()` like `runtimeOnly fg.deobf("mekanism:appliedenergistics2:VERSION:api")`
